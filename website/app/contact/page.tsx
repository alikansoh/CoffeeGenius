...
export default function ContactPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.ok) {
        const msg = body?.message || body?.error || `Failed to send (${res.status})`;
        setErrorMessage(msg);
        setStatus("error");
        liveRef.current?.focus();
        return;
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
          ...
          <section className="bg-white rounded-3xl p-8 shadow-lg border border-gray-200">
            <h1 className="text-2xl md:text-3xl font-extrabold mb-2">Contact us</h1>
            <p className="text-sm text-gray-600 mb-6">
              Have a question or want to purchase equipment? Send us a message and we’ll get back to you as soon as possible.
            </p>
            ...
            {status === "success" && (
              <div className="flex items-start gap-4 bg-green-50 border border-green-100 rounded-lg p-4 mb-6">
                ...
                <div>
                  ...
                  <div className="text-sm text-green-700">Thanks — we’ll respond to your message shortly.</div>
                </div>
              </div>
            )}
          ...
          <aside className="space-y-6">
            <div className="bg-white rounded-3xl p-6 shadow-lg border border-gray-200">
              ...
              <p className="text-sm text-gray-700 mb-4">We’re happy to answer questions or help you choose equipment.</p>

              <div className="flex items-start gap-3 mb-3">
                <Phone className="w-5 h-5 text-black mt-1 flex-shrink-0" />
                <div>
                  <div className="text-sm font-semibold">Phone</div>
                  <a href="tel:+447444724389" className="text-sm text-gray-700 hover:underline">
                    +44 7444 724389
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 mb-3">
                ...
                <div>
                  ...
                  <a href="mailto:hello@coffeegenius.example" className="text-sm text-gray-700 hover:underline">
                    hello@coffeegenius.example
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <address className="not-italic text-sm text-gray-700">
                    ...
                    <div className="mt-2">
                      <Link href={mapsUrlFallback} className="text-sm text-gray-900 hover:underline" target="_blank" rel="noreferrer">
                        Open in Google Maps
                      </Link>
                    </div>
                  </address>
            ...
            <div className="text-sm text-gray-700">
              <p>
                ...
                <a href="mailto:hello@coffeegenius.example" className="text-gray-900 hover:underline">
                  hello@coffeegenius.example
                </a>
                .
              </p>
